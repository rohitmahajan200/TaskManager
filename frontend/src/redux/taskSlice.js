  ...
  async (task, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        "https://taskmanager-1-t5jj.onrender.com/",
        task,
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        "https://taskmanager-1-t5jj.onrender.com/task",
        { withCredentials: true }
      );
...
export const changeStatus = createAsyncThunk(
  ...
  async ({ id, status }, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        `https://taskmanager-1-t5jj.onrender.com/task/${id}`,
        { status },
        { withCredentials: true }
      );
      return response.data;
...
export const getFilterTasks = createAsyncThunk(
  ...
  async (filter, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `https://taskmanager-1-t5jj.onrender.com/task/filter`,
